...
--------------------------------------------------
 ...
 Auther   : handriixlarkaw

 GitHub   : https://github.com/handriix

 YouTube  : Trick Proofz
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WellCome To HANDRIIX_LARKAW')

	    psb('Congratulations HANDRIIX_LARKAW Tool Has Been Updated Successfully')

	    psb('ðŸ”“User Nameâ˜† 786786âœ“')

	    psb('ðŸ”“Password â˜† 786786âœ“')

	    psb('Subscrib My Youtube Channel HANDRIIX LARKAW M4 MASTERâœ“')
